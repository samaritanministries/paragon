  ...
  <Layout>
    ...
    <AppContent>
      <div className="row">
        ...
        <p className="intro">Due to our large audience, it is import to incorporate accessibility best practices within your
    App. We will provide you with today's web accessibility standards in an easy-to-understand format.</p>
