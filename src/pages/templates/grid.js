  ...
  <div>
    ...
    <div className="grid-phoenix fullscreen">
      <header className="header">
        ...
        <div className="spacer">
      	<a href="/templates/dashboard" className="action button button--grey"><i className="dashing-icon dashing-icon--close" /> close</a>
        </div>
      </header>

      <aside className="sidebar">
        <ul className="sidebar-nav">
          <li><i className="dashing-icon dashing-icon--locked" /><a href="/templates/dashboard">Home</a></li>
          <li><i className="dashing-icon dashing-icon--locked" /><a href="/templates/dashboard">Wallet</a></li>
          <li><i className="dashing-icon dashing-icon--locked" /><a href="/templates/dashboard">My Needs</a></li>
          <li><i className="dashing-icon dashing-icon--locked" /><a href="/templates/dashboard">Sign Out</a></li>
        </ul>
      </aside>
      ...
      <section className="app">
        <div className="content" style={{ maxWidth: "600px" }}>
          ...
          <div className="grid">
				  <div className="grid--full" style={{ backgroundColor: "#84a7ed", textAlign: "center", border: "2px solid #3f70c9" }}>.grid--full</div>
				  <div className="grid--half" style={{ backgroundColor: "#84a7ed", textAlign: "center", border: "2px solid #3f70c9" }}>.grid--half</div>
				  <div className="grid--half" style={{ backgroundColor: "#84a7ed", textAlign: "center", border: "2px solid #3f70c9" }}>.grid--half</div>
				  <div className="grid--three-fourths" style={{ backgroundColor: "#84a7ed", textAlign: "center", border: "2px solid #3f70c9" }}>.grid--three-fourths</div>
				  <div className="grid--fourth" style={{ backgroundColor: "#84a7ed", textAlign: "center", border: "2px solid #3f70c9" }}>.grid--fourth</div>
				  <div className="grid--fourth" style={{ backgroundColor: "#84a7ed", textAlign: "center", border: "2px solid #3f70c9" }}>.grid--fourth</div>
				  <div className="grid--fourth" style={{ backgroundColor: "#84a7ed", textAlign: "center", border: "2px solid #3f70c9" }}>.grid--fourth</div>
				  <div className="grid--fourth" style={{ backgroundColor: "#84a7ed", textAlign: "center", border: "2px solid #3f70c9" }}>.grid--fourth</div>
				  <div className="grid--fourth" style={{ backgroundColor: "#84a7ed", textAlign: "center", border: "2px solid #3f70c9" }}>.grid--fourth</div>
				  <div className="grid--two-thirds" style={{ backgroundColor: "#84a7ed", textAlign: "center", border: "2px solid #3f70c9" }}>.grid--two-thirds</div>
				  <div className="grid--third" style={{ backgroundColor: "#84a7ed", textAlign: "center", border: "2px solid #3f70c9" }}>.grid--third</div>
				  <div className="grid--five-sixth" style={{ backgroundColor: "#84a7ed", textAlign: "center", border: "2px solid #3f70c9" }}>.grid--five-sixth</div>
				  <div className="grid--sixth" style={{ backgroundColor: "#84a7ed", textAlign: "center", border: "2px solid #3f70c9" }}>.grid--sixth</div>
				  <div className="grid--sixth" style={{ backgroundColor: "#84a7ed", textAlign: "center", border: "2px solid #3f70c9" }}>.grid--sixth</div>
				  <div className="grid--sixth" style={{ backgroundColor: "#84a7ed", textAlign: "center", border: "2px solid #3f70c9" }}>.grid--sixth</div>
				  <div className="grid--sixth" style={{ backgroundColor: "#84a7ed", textAlign: "center", border: "2px solid #3f70c9" }}>.grid--sixth</div>
				  <div className="grid--sixth" style={{ backgroundColor: "#84a7ed", textAlign: "center", border: "2px solid #3f70c9" }}>.grid--sixth</div>
          ...
          <div className="grid">
				  <div className="grid--full" style={{ backgroundColor: "#84a7ed", textAlign: "center", border: "2px solid #3f70c9", padding: "1rem" }}><div className="card">.grid--full</div></div>
				  <div className="grid--half" style={{ backgroundColor: "#84a7ed", textAlign: "center", border: "2px solid #3f70c9", padding: "1rem" }}><div className="card">.grid--half</div></div>
				  <div className="grid--half" style={{ backgroundColor: "#84a7ed", textAlign: "center", border: "2px solid #3f70c9", padding: "1rem" }}><div className="card">.grid--half</div></div>
				  <div className="grid--two-thirds" style={{ backgroundColor: "#84a7ed", textAlign: "center", border: "2px solid #3f70c9", padding: "1rem" }}><div className="card">.grid--two-thirds</div></div>
				  <div className="grid--third" style={{ backgroundColor: "#84a7ed", textAlign: "center", border: "2px solid #3f70c9", padding: "1rem" }}><div className="card">.grid--third</div></div>
            <div className="grid--third" style={{ backgroundColor: "#84a7ed", textAlign: "center", border: "2px solid #3f70c9", padding: "1rem" }}><div className="card">.grid--third</div></div>
            <div className="grid--two-thirds" style={{ backgroundColor: "#84a7ed", textAlign: "center", border: "2px solid #3f70c9", padding: "1rem" }}><div className="card">.grid--two-thirds</div></div>
          </div>
