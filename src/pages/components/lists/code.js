...
class ListsCode extends React.Component {
      ...
      <Layout>
        ...
        <AppContent>
          <div className="grid grid-padding">
            <h2 id="forms">Forms
              <Link to={`${location.pathname}/#orderedLists`} className="button button--transparent button--copy-link" />
            </h2>
            <div className="row example-container">
              <div className="column column--full" style={{ overflow: "auto" }}>
                <ol className="ordered-list--custom mb-space-m">
  ...
  <li>This is the fourth item</li>
          ...
          <div className="grid grid-padding">
            <h2 id="customColoredLists">Custom Colored Lists
              <Link to={`${location.pathname}/#customColoredLists`} className="button button--transparent button--copy-link" />
            </h2>
            <div className="row example-container">
              <div className="column column--full" style={{ overflow: "auto" }}>
                <ol className="ordered-list--custom ordered-list--color-blue mb-space-m">
