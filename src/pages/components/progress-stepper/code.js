          ...
          <div className="row">
            <div className="column column--full">
              <h2 className="example-header no-margin--top" id="progressStepperTheming">Progress Stepper Theming
                <Link to={location.pathname + "/#progressStepperTheming"} className="button button--transparent button--copy-link"></Link>
              </h2>
...
$progress-color: $green;`}
              ...
              <h2 className="example-header" id="widthOptions">Width Options
                <Link to={location.pathname + "/#widthOptions"} className="button button--transparent button--copy-link"></Link>
              </h2>
  ...
  <div class="progress-labels">
    ...
    <div class="progress-label"><a href="#">Step 3</a></div>
              ...
              <h2 className="example-header" id="twoSteps">Two Steps
                <Link to={location.pathname + "/#twoSteps"} className="button button--transparent button--copy-link"></Link>
              </h2>
              <div className="row example-container">
                <div className="column column--full">
                  <div className="progress">
  ...
  <div class="progress-labels">
    ...
    <div class="progress-label">Step 2</div>
              ...
              <h2 className="example-header" id="threeSteps">Three Steps
                <Link to={location.pathname + "/#threeSteps"} className="button button--transparent button--copy-link"></Link>
              </h2>
              <div className="row example-container">
                <div className="column column--full">
                  <div className="progress">
  ...
  <div class="progress-labels">
    ...
    <div class="progress-label progress-label--completed"><a href="#">Step 3</a></div>
              ...
              <h2 className="example-header" id="fourSteps">Four Steps
                <Link to={location.pathname + "/#fourSteps"} className="button button--transparent button--copy-link"></Link>
              </h2>
              <div className="row example-container">
                <div className="column column--full">
                  <div className="progress">
