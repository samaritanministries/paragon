    ...
    return (
      <Layout>
        ...
        <AppContent>
            ...
            <h2 id="forms">Forms
              <Link to={`${location.pathname}/#forms`} className="button button--transparent button--copy-link" />
            </h2>
...
`}
            ...
            <h2 className="mt-space-xl" id="selectMenu">Select Menu
              <Link to={`${location.pathname}/#selectMenu`} className="button button--transparent button--copy-link" />
            </h2>
    ...
    <select id="form-add-on-menu">
      ...
      <option>Option 3</option>
            ...
            <h2 className="mt-space-xl" id="inputGroups">Input Groups
              <Link to={`${location.pathname}/#inputGroups`} className="button button--transparent button--copy-link" />
            </h2>
            <div className="example-container">
              <div className="card">
        ...
        <button class="button--icon button--border add-on--after">
          <i class="dashing-icon dashing-icon--search"></i>
            ...
            <h2 className="mt-space-xl" id="inputMessageStates">Input Message States
              <Link to={`${location.pathname}/#inputMessageStates`} className="button button--transparent button--copy-link" />
            </h2>
            <div className="example-container">
              <div className="card">
                <div className="card-content">
  ...
  <fieldset class="has-warning">
    ...
    <div class="message">Use warnings to convey important messages to your user.</div>
            ...
            <h2 className="mt-space-xl" id="otherSupportedInputTypes">Other Supported Input Types
              <Link to={`${location.pathname}/#otherSupportedInputTypes`} className="button button--transparent button--copy-link" />
            </h2>
            <div className="example-container">
              <div className="card">
                <div className="card-content">
  ...
  <fieldset>
    ...
    <input type="file" id="file"/>
            ...
            <h2 className="mt-space-xl" id="customRangeSlider">Custom Range Slider
              <Link to={`${location.pathname}/#customRangeSlider`} className="button button--transparent button--copy-link" />
            </h2>
...
<input type="range" id="range"/>
            ...
            <h2 className="mt-space-xl" id="formExample">Form Example
              <Link to={`${location.pathname}/#formExample`} className="button button--transparent button--copy-link" />
            </h2>
            <div className="example-container">
              <div className="card">
