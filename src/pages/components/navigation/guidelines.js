    ...
    <AppContent>
      <div className="row">
        <div className="column column--full">
          <p class="intro">As users interact within your App, it is important to provide them with a navigation experience that is consistent
          ...
          <h2 class="has-number has-number--one no-margin--top">Basic Header</h2>
          ...
          <div class="image-container double-spacing">
            <nav class="app-menu" style={{ position: "relative", backgroundColor: "#828b94" }}>
              <div class="app-context">
                <div class="app-title" style={{ color: "#FFF" }}>App Title</div>
              </div>
            </nav>
          </div>

          <h2 class="has-number has-number--two">Meeting Usability Standards</h2>
          ...
          <div class="image-container double-spacing">
            <nav class="app-menu" style={{ position: "relative", backgroundColor: "#754c82", width: "calc(50% - 4px)", display: "inline-block" }}>
              <div class="app-context">
                <div class="app-title" style={{ color: "#FFF" }}>App Title</div>
              </div>
            </nav>
            <nav class="app-menu" style={{ position: "relative", backgroundColor: "#dbc0dc", width: "50%", display: "inline-block" }}>
              <div class="app-context">
          ...
          <h2 class="has-number has-number--three">Navigation Tabs</h2>
          ...
          <div class="image-container double-spacing">
            <div class="flex-container">
              ...
              <nav class="app-menu" style={{ position: "relative", backgroundColor: "#35b16c" }}>
                <div class="app-context">
                  <div class="app-title" style={{ color: "#FFF" }}>App Title</div>
                </div>
                <ul class="app-navigation example-page--app-navigation">
                  <li><a href="/components/navigation/guidelines" class="active" ref={(el) => {
                      if (el) {
          ...
          <h2 class="has-number has-number--four">Navigating Within Tabs</h2>
          ...
          <div class="image-container double-spacing">
            <nav class="app-menu" style={{ position: "relative", backgroundColor: "#708cc7" }}>
              <div class="app-context">
                <div class="app-title" style={{ color: "#FFF" }}>
                  <a href="/components/navigation/guidelines" class="button button--navigation example-button--navigation" ref={(el) => {
                      if (el) {
                        el.style.setProperty('color', '#FFF', 'important');
                      }
          ...
          <h2 class="has-number has-number--five">Navigating Outside of Tabs</h2>
          ...
          <div class="image-container">
            <div class="image" id="navigation--banner"></div>
          </div>
