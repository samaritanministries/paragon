      ...
      <div className="row">
        <div className="column column--full">
          ...
          <h2 className="has-number has-number--one no-margin--top">Buttons within Cards</h2>
            <p>Call to actions within cards should be placed in the card footer and left aligned. If there is only one action in the footer, this should be center aligned. This pattern supports the <a href="https://www.nngroup.com/articles/f-shaped-pattern-reading-web-content/" rel="noopener noreferrer" target="_blank">F-pattern layout</a>.</p>
