  ...
  <Layout>
    ...
    <AppContent>
      <div className="grid grid-padding">
        ...
        <h2 className="example-header no-margin--top" id="pageBanner">Page Banner
...
{`<div class="page-banner">
  <h1>Page Banner</h1>
        ...
        <h2 className="example-header" id="pageBannerWithSubhead">Page Banner with subhead
...
{`<div class="page-banner">
  ...
  <h4>Need #481516 – Broken Arm</h4>
          ...
          <h2 className="example-header" id="defaultCardBanner">Default Card Banner
...
{`<div class="card">
  ...
  <div class="card-footer">
    <p>Use a banner within a card to display additional context</p>
          ...
          <h2 className="example-header" id="cardBannerWithSuccess">Card Banner with success
...
{`<div class="card">
  ...
  <div class="card-footer">
    <p>Use success banners to notify users of a successful action.</p>
          ...
          <h2 className="example-header" id="cardBannerWithWarning">Card Banner with warning
...
{`<div class="card">
  ...
  <div class="card-footer">
    <p>Use warning banners to inform your user of potential errors.</p>
          ...
          <h2 className="example-header" id="cardBannerWithError">Card Banner with error
...
{`<div class="card">
  ...
  <div class="card-footer">
    <p>Use error banners to display critical and important information to your user after they have performed an action.</p>
          ...
          <h2 className="example-header" id="cardBannerWithButton">Card Banner with button
...
{`<div class="card">
  ...
  <div class="card-footer">
    <p>Use a banner within a card to display additional context. If you have a button make sure to add <code class="example-text">.has-button</code> to reduce the padding.</p>
          ...
          <h2 className="example-header" id="cardBannerWithLink">Card Banner with link
