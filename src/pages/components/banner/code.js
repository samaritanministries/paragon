...
{`<div class="page-banner">
  <h1>Page Banner</h1>
            ...
            <h2 className="example-header">Page Banner with subhead <button className="button button--transparent button--copy-link" id="Page_Banner_With_Subhead"/></h2>
          <div className="row example-container">
            <div className="column column--full">
              <div className="page-banner" style={{ position: "relative" }}>
...
{`<div class="card">
  ...
  <div class="card-footer">
    <p>Use a banner within a card to display additional context</p>
          ...
          <h2 className="example-header" id="cardBannerSuccess">Card Banner with success <button className="button button--transparent button--copy-link" id="Card_Banner_With_Success"/></h2>
          <div className="row example-container">
            <div className="column column--full">
...
{`<div class="card">
  ...
  <div class="card-footer">
    <p>Use warning banners to inform your user of potential errors.</p>
          ...
          <h2 className="example-header" id="cardBannerError">Card Banner with error <button className="button button--transparent button--copy-link" id="Card_Banner_With_Error"/></h2>
          <div className="row example-container">
            <div className="column column--full">
              <div className="card no-margin">
                <div className="card-header">
...
{`<div class="card">
  ...
  <div class="card-footer">
    <p>Use error banners to display critical and important information to your user after they have performed an action.</p>
          ...
          <h2 className="example-header" id="cardBannerButton">Card Banner with button <button className="button button--transparent button--copy-link" id="Card_Banner_With_Button"/></h2>
          <div className="row example-container">
            <div className="column column--full">
              <div className="card no-margin">
                <div className="card-header">
...
{`<div class="card">
  ...
  <div class="card-footer">
    <p>Use a banner within a card to display additional context. If you have a button make sure to add <code class="example-text">.has-button</code> to reduce the padding.</p>
          ...
          <h2 className="example-header" id="cardBannerLink">Card Banner with link <button className="button button--transparent button--copy-link" id="Card_Banner_With_Link" /></h2>
          <div className="row example-container">
            <div className="column column--full">
              <div className="card no-margin">
                <div className="card-header">
